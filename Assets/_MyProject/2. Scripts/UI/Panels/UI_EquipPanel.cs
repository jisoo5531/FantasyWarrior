...
{            
    ...
    private void HelmetSlotSetting()
    {
        if (playerEquipData.HeadItem_ID != 0)
        {
            ...
            HeadArmorSlot.Initialize(playerEquipData.HeadItem_ID, sprite, EquipItemInfo);       
        }
        else
        {
            // 장비를 장착하지 않은 경우            
    ...
    private void ArmorSlotSetting()
    {
        if (playerEquipData.ArmorItem_ID != 0)
        {
            ...
            Sprite sprite = Resources.Load<Sprite>($"Items/Icon/{itemName}");
            BodyArmorSlot.Initialize(playerEquipData.ArmorItem_ID, sprite, EquipItemInfo);            
        }
        else
        {
            // 장비를 장착하지 않은 경우            
    ...
    private void GloveSlotSetting()
    {
        if (playerEquipData.GloveItem_ID != 0)
        {
            ...
            Sprite sprite = Resources.Load<Sprite>($"Items/Icon/{itemName}");
            GloveSlot.Initialize(playerEquipData.GloveItem_ID, sprite, EquipItemInfo);            
        }
        else
        {
            // 장비를 장착하지 않은 경우            
    ...
    private void BootsSlotSetting()
    {
        if (playerEquipData.BootItem_ID != 0)
        {
            ...
            Sprite sprite = Resources.Load<Sprite>($"Items/Icon/{itemName}");
            BootsSlot.Initialize(playerEquipData.BootItem_ID, sprite, EquipItemInfo);            
        }
        else
        {
            // 장비를 장착하지 않은 경우            
    ...
    private void WeaponSlotSetting()
    {
        if (playerEquipData.WeaponItem_ID != 0)
        {
            ...
            Sprite sprite = Resources.Load<Sprite>($"Items/Icon/{itemName}");
            WeaponSlot.Initialize(playerEquipData.WeaponItem_ID, sprite, EquipItemInfo);            
        }
        else
        {
            // 장비를 장착하지 않은 경우            
    ...
    private void PendantSlotSetting()
    {
        if (playerEquipData.Pendant_ID != 0)
        {
            ...
            Sprite sprite = Resources.Load<Sprite>($"Items/Icon/{itemName}");
            PendantSlot.Initialize(playerEquipData.Pendant_ID, sprite, EquipItemInfo);            
        }
        else
        {
            // 장비를 장착하지 않은 경우            
    ...
    private void RingSlotSetting()
    {
        if (playerEquipData.Ring_ID != 0)
        {
            ...
            Sprite sprite = Resources.Load<Sprite>($"Items/Icon/{itemName}");
            RingSlot.Initialize(playerEquipData.Ring_ID, sprite, EquipItemInfo);            
        }
        else
        {
            // 장비를 장착하지 않은 경우            
